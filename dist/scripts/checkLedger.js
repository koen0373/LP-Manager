...
async function main() {
    ...
    const [positionEventsCount, positionTransfersCount, capitalFlowsCount,] = await Promise.all([
        prisma_1.db.positionEvent.count(),
        prisma_1.db.positionTransfer.count(),
        prisma_1.db.capitalFlow.count(),
    ]);

...
function getPoolAddress(factory, token0, token1, fee) {
    ...
    const addressHash = (0, viem_1.keccak256)(`0x${create2Input}`);
    // Take last 20 bytes (40 hex chars) as address
    const address = (0, viem_1.getAddress)(`0x${addressHash.slice(-40)}`);
    return address;
}

  ...
  return (
    <main className="min-h-screen relative text-white">
      ...
      <header className="flex items-center justify-between px-6 py-5">
        ...
        <form onSubmit={doLogin} className="flex items-center gap-2">
          <input
            ...
            className="rounded-md bg-white/10 border border-white/15 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[#3B82F6]"
            value={pwd}
          ...
          <button
            type="submit"
            disabled={busy}
            className="rounded-md bg-[#3B82F6] text-white px-4 py-2 text-sm font-semibold transition-colors hover:bg-[#60A5FA] disabled:opacity-60"
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-24 md:py-36">
        ...
        <p className="mt-2 text-sm text-[#9CA3AF]">Have an access password? Use the login in the top-right.</p>

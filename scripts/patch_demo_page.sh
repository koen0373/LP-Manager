...
git add pages/demo.tsx
git commit -m "demo: add /demo page for multi-wallet portfolio (analytics first, live fallback)" || true

echo "✅ Added /demo page. Open http://127.0.0.1:3000/demo"

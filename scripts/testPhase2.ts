...
import { normalizePositions } from '../src/lib/discovery/normalize';

// Test wallet address (replace with your own for testing)
const TEST_WALLET = '0x57d294D815968F0EFA722f1E8094da65402cd951' as `0x${string}`;

async function testDiscovery() {
  console.log('\n🔹 Testing Wallet Discovery...');
  
  try {
    const discovery = await discoverWalletPositions(TEST_WALLET, {

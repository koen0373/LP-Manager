...
const demoPools: DemoPoolRow[] = [
  {
    ...
    status: 'in',
    token0Icon: '/media/tokens/hln.webp',
    token1Icon: '/media/tokens/usd0.webp',
    provider: 'Enosys',
  },
  {
    tokenId: '#22088',
    ...
    currentPrice: '0.318',
    status: 'near',
    token0Icon: '/media/tokens/sflr.webp',
    token1Icon: '/media/tokens/usd0.webp',
    provider: 'Enosys',
  },
  {
    ...
    status: 'in',
    token0Icon: '/media/tokens/flr.webp',
    token1Icon: '/media/tokens/usd0.webp',
    provider: 'Enosys',
  },
  {
    ...
    currentPrice: '2.311',
    status: 'in',
    token0Icon: '/media/tokens/fxrp.webp',
    token1Icon: '/media/tokens/usd0.webp',
    provider: 'SparkDEX',
  },
  {
    ...
    status: 'near',
    token0Icon: '/media/tokens/flr.webp',
    token1Icon: '/media/tokens/fxrp.webp',
    provider: 'SparkDEX',
  },
  {
    tokenId: '#SPX03',
    ...
    currentPrice: '0.371',
    status: 'in',
    token0Icon: '/media/tokens/sgb.network.webp',
    token1Icon: '/media/tokens/usdx.webp',
    provider: 'SparkDEX',
  },
  {
    tokenId: '#SPX04',
  ...
  },
  {
    ...
    status: 'near',
    token0Icon: '/media/tokens/flr.webp',
    token1Icon: '/media/tokens/hln.webp',
    provider: 'BlazeSwap',
  },
  {
    tokenId: '#23211',
    ...
    status: 'near',
    token0Icon: '/media/tokens/sgb.network.webp',
    token1Icon: '/media/tokens/sflr.webp',
    provider: 'BlazeSwap',
  },
];

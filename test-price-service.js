...
const { getTokenPriceUsd, getTokenPriceWithFallback, getCacheStats } = require('../src/services/tokenPriceService');
...
async function testPriceService() {
  ...
  console.log(`  Cache hits: ${stats.hits}, misses: ${stats.misses}, keys: ${stats.keys}`);
